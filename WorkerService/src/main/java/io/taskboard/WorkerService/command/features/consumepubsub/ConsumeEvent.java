package io.taskboard.WorkerService.command.features.consumepubsub;
...
public class ConsumeEvent {
    ...
    public ConsumeEvent(IEventPublisher.Publisher eventPublisher) {
...
// messages to the input message channel.
    ...
    public PubSubInboundChannelAdapter inboundChannelAdapter(
        ...
        PubSubInboundChannelAdapter adapter =
                new PubSubInboundChannelAdapter(pubSubTemplate, "dbtest");
